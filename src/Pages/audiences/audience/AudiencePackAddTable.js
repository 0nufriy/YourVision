...
const AudiencePackAddTable = ({language, audiences,setAudiences}) => {
    ...
    <table>
        <tr>
         ...
         {audiences.map((item,index) =>
              ...
              <td>{item.age + " " + stringsText.YersOld}</td>
              <td style={{textAlign: "center"}}>{item.sex? stringsText.Man: stringsText.Woman}</td>
...
export default AudiencePackAddTable
